...
<div class="index__content">
    ...
    <div class="button__content">
        <form class="button__item" action="/attendance/start" method="post">
            @csrf
            <button class="attendance__start" type="submit" name="start_work"
            @if(isset($_POST['start_work'])) disabled
            @elseif(isset($_POST['end_work'])) enabled
            @elseif(isset($_POST['start_rest'])) disabled
            @elseif(isset($_POST['end_rest'])) disabled
            @endif>勤務開始</button>
        </form>
